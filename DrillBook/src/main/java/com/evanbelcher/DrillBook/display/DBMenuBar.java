...
public class DBMenuBar extends JMenuBar implements ActionListener {
	 ...
	 */
	private void about() {
		String msg = "<html>DrillBook " + State.VERSION + "<br>Created by Evan Belcher, 2016<br><a href=\"https://github.com/EbMinor3/DrillBook\">GitHub</a><br><a href=\"http://evanbelcher.com\">Website</a><br><br><a href=\"https://icons8.com\">Icon pack by Icons8</a></html>";
		...
		if (askToSave()) {
			...
			if (returnVal == JFileChooser.APPROVE_OPTION) {
				try {
					...
					name = file.getName().toLowerCase().endsWith(".drill") ? file.getName() : file.getName() + ".drill";
