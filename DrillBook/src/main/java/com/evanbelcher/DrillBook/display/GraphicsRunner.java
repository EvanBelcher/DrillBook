...
import com.evanbelcher.DrillBook.play.PagePlayer;
...
public class GraphicsRunner extends JFrame implements Runnable {
	...
	@Override public void run() {
		...
		//set up the frame
		desktop = new DBDesktopPane();
		setContentPane(desktop);
		setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
		setBounds(SCREEN_SIZE);
		setResizable(false);
		handleClosing();
		menuBar = new DBMenuBar(this, desktop);
		setJMenuBar(menuBar);
	 ...
	 *
	 * @param desktop the current DBDesktopPane
	 */
	public void toPlayMode(DBDesktopPane desktop) {
	...
	/**
	 * Makes the DBDesktopPane the contentPane
	 */
