...
import com.evanbelcher.DrillBook.data.State;
import com.evanbelcher.DrillBook.display.DBDesktopPane;
...
public class PlayerDesktopPane extends JDesktopPane {
	 ...
	 * @param desktopPane The DBDesktopPane to inherit the size from
	 * @param points      The points to display
	 */
	public PlayerDesktopPane(PlayerInternalFrame pif, DBDesktopPane desktopPane, HashMap<MovingPoint, String> points) {
		super();
		this.points = points;
		this.dotSize = DBDesktopPane.getDotSize();
