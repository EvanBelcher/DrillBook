...
package com.evanbelcher.DrillBook.play.data;
...
public class MovingPoint {
	...
	public MovingPoint(Point oldPoint, Point newPoint, int subdivisions) {
		...
		if (start.distance(start.getX() + subdivisions * dx, start.getY() + subdivisions * dy) / counts > 2 * (DBDesktopPane.getField().getWidth() / 100))
			color = Color.RED;
		else
			color = Color.BLACK;
	}
